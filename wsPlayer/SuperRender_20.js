  ...
  // console.log('rrr .', r)
    ...
    function e(e) {
      console.log('eeeee', this)
        ...
        if (this.contextGL) {
            ...
            this.initBuffers();
            this.initTextures();
            this.contextGL.pixelStorei(this.contextGL.UNPACK_ALIGNMENT, 1);
        }
    }
    e.prototype.initContextGL = function () {
        ...
        if (null == r) {
            ...
            alert("Google Chrome 硬件加速失败，请尝试点击右上角设置-高级-系统关闭硬件加速并重启,或升级Chrome到最新版本");
        }
    };
    ...
    e.prototype.SR_DisplayFrameData = function (width, height, Ydata, Udata, Vdata) {
        if (width <= 0 || height <= 0) {
            return
        }
